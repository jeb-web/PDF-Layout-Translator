...
#### **2. Fichier Modifié : `src/gui/main_window.py`**

Remplacez intégralement le contenu de ce fichier. Il contient l'ajout du nouveau bouton, du message d'aide pour les dépendances, et de la logique asynchrone pour la traduction.
