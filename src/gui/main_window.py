...
*** VERSION v2.7.1 - Correction de la gestion des onglets Notebook ***
"""
...
# Le prompt de l'IA est maintenant géré par le programme
...
class MainWindow:
    ...
    def _setup_window(self):
        self.root.title("PDF Layout Translator v2.7.1")
    ...
    def _create_ai_interaction_tab(self):
        ...
        # --- CORRECTION ---
        # Remplacer insert() par add() pour plus de robustesse.
        # L'onglet est ajouté séquentiellement après "Analyse", ce qui est correct.
        self.notebook.add(self.ai_frame, text="🤖 Interaction IA")
            ...
            if self.use_ai_flow_var.get():
                ...
                try:
                    ...
                    def update_ui_for_ai():
                        # Utiliser l'objet frame (self.ai_frame) pour le montrer, pas l'index
